...
namespace ContosoRetail.SharedKernel.DataAccess.DataLoader
{
    ...
    public class DefaultAccessor<T> : ContosoRetail.SharedKernel.DataAccess.DataLoader.ExpressionCompiler, ContosoRetail.SharedKernel.DataAccess.DataLoader.IAccessor<T>
    {
